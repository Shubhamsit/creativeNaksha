...
function Body() {
  ...
  const imageUrls = [
    "../src/assets/architectwork.jpg",
    "../src/assets/design3d.jpg",
    "../src/assets/interior.jpg",
    "../src/assets/vastu.jpg",
    "../src/assets/structural.jpg",
    ...
    <div className="overflow-x-hidden"> 
      <div className='sm:flex sm:flex-row flex-col justify-start  sm:h-[800px] h-[500px]'>
        ...
        <div className='sm:w-[50%] w-full bg-[#40DFEF]'>
          <img src="../src/assets/architect.png" alt="Architect Design" className='w-full max-w-full object-cover  relative sm:top-28' />
        </div>
